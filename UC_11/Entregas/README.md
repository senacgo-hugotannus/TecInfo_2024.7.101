# Instruções para Entrega de Exercícios da UC 11

1. Crie uma pasta com o seu nome para realizar suas entregas da UC 11 dentro da pasta `./UC_11/Entregas`
2. Para realizar as entregas, você pode:
    - Criar um arquivo do tipo `.py` para cada exercício; ou
    - Criar um único arquivo do tipo `.ipynb` para responder a toda a lista.
